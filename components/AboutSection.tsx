...
function AboutSection({ locale }: AboutSectionProps) {
    ...
    return (
        <section className='my-10 px-5'>
            <div >
                <h2 className="text-3xl font-bold tracking-tight text-foreground md:text-4xl text-center mb-4"> {getTranslation(locale, "aboutsection.title")}</h2>
                <p className="mx-auto max-w-4xl text-black/90 text-center mb-6 font-medium text-base">{getTranslation(locale, "aboutsection.description")}</p>
