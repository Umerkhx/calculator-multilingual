...
export function CalculatorSearch({ locale }: CalculatorSearchProps) {
  ...
  const handleKeyDown = (e: React.KeyboardEvent) => {
    if (e.key === "ArrowDown") {
      ...
      if (selected) {
        window.location.href = `/${locale}/calculators/${selected.categoryId}/${selected.slug}`;
                  ...
                  <div className="mb-6">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="text-sm font-semibold">
                        {getTranslation(locale, "search.recentSearches")}
                      </h3>
                    </div>
                              ...
                              {item.calculators.map((calc, idx) => {
                                ...
                                return (
                                  <Link
                                    ...
                                    className={`flex items-center justify-between group rounded-lg px-4 py-3 transition-all ${
