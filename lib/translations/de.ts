...
export const deTranslations = {
  ...
  finance: {
    ...
    breakeven: {
      ...
      resultExplain: "Dies ist die Anzahl der Einheiten, die Sie verkaufen müssen, um alle Fix- und variablen Kosten zu decken, bevor Sie Gewinn machen.",
