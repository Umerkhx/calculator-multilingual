...
export const esTranslations = {
  hero: {
    ...
    subtitle: "Calculadora Vast ofrece una completa gama de herramientas de calculadora en línea que cubren finanzas, salud, educación y conversiones matemáticas diarias. Cada calculadora proporciona resultados instantáneos, precisos y sin publicidad, ayudando a estudiantes, profesionales y usuarios cotidianos a simplificar cálculos complejos.",
  ...
  aboutsection: {
    ...
    description: "Los números impulsan cada decisión, y Calculadora Vast hace que esos números sean más fáciles de entender. Desde conversiones matemáticas simples hasta análisis financieros complejos, nuestras herramientas de calculadora gratuitas en línea convierten las fórmulas en resultados precisos e instantáneos. Diseñado para la accesibilidad, la fiabilidad y la simplicidad, Calculadora Vast garantiza que cada cálculo sea sin esfuerzo.",
  ...
  categories: {
    health: {
      metaTitle: "Calculadoras de Salud | Herramientas precisas en línea para fitness y bienestar",
      name: "Calculadoras de Salud",
      description: "Controla tu bienestar fácilmente con nuestras calculadoras de IMC, calorías y consumo de agua. Estas herramientas están diseñadas para apoyar un estilo de vida equilibrado y una autoevaluación precisa.",
      metaDescription: "Explora calculadoras de salud en línea gratis para IMC, calorías, grasa corporal, frecuencia cardíaca y más. Mantente en forma y saludable fácilmente."
    },
    finance: {
      metaTitle: "Calculadoras Financieras | Herramientas inteligentes en línea para dinero y ahorros",
      name: "Calculadoras Financieras",
      description: "Planifica mejor tu presupuesto con nuestra calculadora de préstamos, EMI y de interés compuesto. Ya sean gastos diarios o ahorros a largo plazo, VastCalculator aporta claridad a tus decisiones financieras.",
      metaDescription: "Usa calculadoras financieras gratuitas en línea para préstamos, ROI, ahorros e inversiones. Toma decisiones financieras más inteligentes en segundos."
    },
  ...
  result: {
    ...
    noresultssub: "Introduce tus datos y pulsa “Calcular” para ver los resultados.",
...
>>>>>>> bd168e476cb4ec64ba35a5bc0dcf86e4955caa17
      ...
      section1Content: "La Calculadora de Grasa Corporal te ayuda a determinar qué parte de tu peso corporal proviene de la grasa en comparación con el tejido magro. Proporciona tu porcentaje de grasa corporal, masa corporal magra (LBM) y masa grasa usando mediciones simples como altura, peso, circunferencia de cintura y cuello. Esta herramienta en línea ofrece una evaluación rápida y precisa de tus métricas de salud y condición física, ayudándote a comprender tu índice de salud actual. Es una herramienta valiosa para quienes desean hacer un seguimiento de su progreso en fitness, pérdida de peso o mejora de la composición corporal.",
      section1ExtraText: "Después de calcular tu porcentaje de grasa corporal, descubre cuántas calorías quemas al día con nuestra ",
      section1Link: "Calculadora TDEE",

      section1Sub1Title: "¿Por qué usar una Calculadora de Grasa Corporal?",
      section1Sub1Intro: "Controlar tu grasa corporal es esencial para comprender tu salud general. A diferencia del peso, que solo muestra una parte, la proporción de grasa corporal ofrece información más precisa sobre tu estado físico y de salud. Dos personas con el mismo peso pueden tener porcentajes de grasa corporal muy diferentes, lo que significa que su condición física también puede variar.",
      section1Sub1List: [
      ...
      section1Sub1Text: "Nuestra calculadora de grasa corporal te ayuda a medir tu grasa, seguir los cambios y entender cómo tus esfuerzos están afectando tu salud.",

      section1Sub2Title: "Cómo funciona la Calculadora de Grasa Corporal",
      section1Sub2Intro: "La calculadora utiliza tus medidas corporales para estimar el porcentaje de grasa corporal mediante fórmulas científicamente validadas. ¡Es rápida y fácil de usar! Solo ingresa los siguientes datos:",
      section1Sub2List: [
        "Género",
        "Altura",
        "Peso",
      ...
      section1Sub2Text: "Al hacer clic en Calcular, obtendrás un desglose instantáneo de:",
      section1Sub2EndList: [
        "Tu porcentaje de grasa corporal",
        "Tu masa corporal magra",
        "Tu masa grasa"
      ],
      section1Sub2End: "Esto te ayuda a comprender la proporción entre el peso magro (músculos, huesos) y la grasa en tu cuerpo.",

      section1Sub3Title: "¿Por qué medir la grasa corporal y no solo el peso?",
      section1Sub3Intro: "El peso por sí solo no ofrece una visión completa de tu salud. La calculadora de grasa corporal brinda una perspectiva más detallada de tu composición corporal. Al conocer tu porcentaje de grasa y masa magra, puedes:",
      section1Sub3List: [
      ...
      section1Sub3End: "Con esta herramienta, no necesitas equipos profesionales para obtener información útil sobre tu progreso físico. Úsala para monitorear tu evolución y optimizar tus resultados.",

      formulatitle: "Fórmula de la Calculadora de Grasa Corporal",
      formulaText: "La Calculadora de Grasa Corporal utiliza fórmulas científicamente probadas, como la Fórmula de la Marina de los EE. UU., para estimar tu porcentaje de grasa corporal. Funciona comparando tus medidas corporales (cintura, cuello y, para mujeres, cadera) con tu altura y género para determinar tu masa grasa y masa magra. Estas fórmulas son ampliamente reconocidas por su fiabilidad al calcular la composición corporal sin necesidad de herramientas profesionales.",
      formulasubtitle1: "Fórmula de la Marina de EE. UU.",
      formulaMale: "Para hombres: Grasa Corporal % = 86.010 × log10(Cintura − Cuello) − 70.041 × log10(Altura) + 36.76",
      formulaFemale: "Para mujeres: Grasa Corporal % = 163.205 × log10(Cintura + Cadera − Cuello) − 97.684 × log10(Altura) − 78.387",
      formulasubtitle2: "Entendiendo la Fórmula",
      formulasub2Image: "/Body-Fat-Calculator.jpg",
      formulasub2ImageAlt: "Body Fat calculator",
      formulasub2text: "Estas ecuaciones estiman tu proporción de grasa comparando la diferencia entre el tamaño total del cuerpo y las áreas centrales de circunferencia.",
      formulasub2List: [
      ...
      formulasub2end2: "Estos valores te ayudan a comprender cuánto de tu peso corresponde a tejido magro (músculos, huesos, órganos) frente a grasa almacenada.",
      ...
      formulastep1: "Grasa Corporal % = 86.010 × log10(85−38) − 70.041 × log10(175) + 36.76 = 86.010 × 1.672 − 70.041 × 2.243 + 36.76 = 22.96% (≈23%)",
      formulasteptitle2: "Paso 2: Calcular Masa Grasa y Masa Magra",
      formulastepList: [
        "Masa Grasa = 70 × 0.23 = 16.1 kg",
        "Masa Magra = 70 − 16.1 = 53.9 kg"
      ],
      resulttext: "Resultado: Esta persona tiene un 23% de grasa corporal, con 16.1 kg de masa grasa y 53.9 kg de masa corporal magra (LBM).",
      ...
      formulasub4content: "Un porcentaje de grasa más bajo generalmente indica mejor condición física, tono muscular y salud general. Un nivel más alto puede aumentar el riesgo de varios problemas de salud.",
      formulasub5title: "Por qué esta Fórmula es Confiable",
      formulasub5content: "El método de la Marina de EE. UU. es muy confiable por su simplicidad y precisión. Proporciona estimaciones realistas para quienes no tienen acceso a herramientas avanzadas como escáneres DEXA. Esta calculadora ofrece resultados rápidos y basados en datos que reflejan tu verdadera composición física. La Calculadora de Grasa Corporal de Vast Calculators utiliza las mismas fórmulas para brindar resultados instantáneos y precisos.",
...
>>>>>>> bd168e476cb4ec64ba35a5bc0dcf86e4955caa17
    pace: {
      ...
      aboutText: "Calcula tu ritmo promedio de carrera según la distancia y el tiempo.",
      formula: "Fórmula",
      formulaText: "Ritmo = Tiempo / Distancia",
      faqTitle: "Preguntas Frecuentes sobre el Ritmo de Carrera",
      faq: [
        {
          q: "¿Cuál es un buen ritmo al correr?",
          a: "Para corredores casuales, entre 6–7 min/km es promedio. Los avanzados pueden bajar de 5 min/km.",
        },
        {
          q: "¿Por qué es importante el ritmo?",
          a: "Ayuda a monitorear el progreso y controlar la intensidad durante el entrenamiento o las carreras.",
        },
        {
          q: "¿Debe mantenerse constante el ritmo?",
          a: "Idealmente sí, aunque los principiantes suelen comenzar más lento y acelerar con el tiempo.",
        },
        {
          q: "¿El terreno afecta el ritmo?",
          a: "Sí, las cuestas, arena o superficies irregulares pueden reducirlo considerablemente.",
        },
        {
          q: "¿Cómo puedo mejorar mi ritmo?",
          a: "Con entrenamiento por intervalos, buena técnica y trabajo cardiovascular constante.",
        },
        {
          q: "¿El ritmo es lo mismo que la velocidad?",
          a: "Están relacionados — el ritmo es minutos por kilómetro, y la velocidad es kilómetros por hora.",
        },
      ],
    },
    ...
    heartRate: {
      ...
      desc: "Calcula tus zonas de entrenamiento cardíaco",
      age: "Edad (años)",
      restingHR: "Frecuencia Cardíaca en Reposo (ppm)",
      result: "Zonas Cardíacas",
      about: "Acerca de las Zonas Cardíacas",
      aboutText: "Cada zona cardíaca corresponde a un nivel de intensidad diferente durante el entrenamiento.",
      formula: "Fórmula",
      formulaText:
        "Usa la fórmula de Karvonen: FC Objetivo = (FC Máx - FC Reposo) × Intensidad + FC Reposo",
      faqTitle: "Preguntas Frecuentes sobre la Calculadora de Frecuencia Cardíaca",
      faq: [
        {
          q: "¿Qué son las zonas de frecuencia cardíaca?",
          a: "Son niveles de intensidad basados en tu frecuencia cardíaca — desde actividad ligera hasta esfuerzo máximo.",
        },
        {
          q: "¿Cómo encuentro mi frecuencia cardíaca máxima?",
          a: "Un cálculo común es 220 menos tu edad, aunque puede variar según tu condición física.",
        },
        {
          q: "¿Qué zona quema más grasa?",
          a: "La Zona 2 (60–70% de tu FC máx) es la más efectiva para quemar grasa.",
        },
        {
          q: "¿Puedo entrenar solo en mi zona máxima?",
          a: "No, hacerlo constantemente puede causar fatiga o lesiones. Es mejor equilibrar todas las zonas.",
        },
        {
          q: "¿Los relojes inteligentes son precisos?",
          a: "Son aceptables, pero las bandas pectorales son más confiables para mediciones exactas.",
        },
        {
          q: "¿Por qué es importante la frecuencia cardíaca en reposo?",
          a: "Una FC en reposo baja suele indicar buena salud cardiovascular.",
        },
      ],
    },
    ...
    protein: {
      ...
      aboutText:
        "Las necesidades de proteína varían según tus objetivos de fitness y tu peso corporal.",
      formula: "Fórmula",
      formulaText:
        "Mantenimiento: 0.8g/kg, Músculo: 1.6–2.2g/kg, Pérdida: 1.2–1.6g/kg",
      faqTitle: "Preguntas Frecuentes sobre la Calculadora de Proteína",
      faq: [
        {
          q: "¿Cuánta proteína necesito al día?",
          a: "La mayoría necesita entre 0.8 y 1g por kg para mantenimiento; más si buscas ganar músculo o perder grasa.",
        },
        {
          q: "¿El exceso de proteína es malo?",
          a: "Solo si tienes problemas renales previos. En personas sanas, altas ingestas son seguras.",
        },
        {
          q: "¿Importa el momento en que tomo proteína?",
          a: "No mucho. Lo importante es cumplir con tu objetivo diario total.",
        },
        {
          q: "¿Qué alimentos son ricos en proteína?",
          a: "Pollo, huevos, yogur griego, tofu, lentejas y pescado son excelentes fuentes.",
        },
        {
          q: "¿Puedo ganar músculo sin suplementos?",
          a: "Sí. Una dieta equilibrada con alimentos naturales es suficiente.",
        },
        {
          q: "¿La proteína ayuda a perder grasa?",
          a: "Sí. Te mantiene lleno más tiempo y preserva músculo durante el déficit calórico.",
        },
      ],
    },
...
>>>>>>> bd168e476cb4ec64ba35a5bc0dcf86e4955caa17
      ...
      section1Sub1Intro: "Tu TDEE es la base de una planificación nutricional inteligente. Te ayuda a:",
      section1Sub1List: [
      ...
      section1Sub1Text: "Al comprender tu estimación de quema calórica, puedes ajustar tu dieta para alcanzar tus objetivos y evitar conjeturas.",

      section1Sub2Title: "Cómo Funciona la Calculadora TDEE Online",
      section1Sub2Intro: "La calculadora primero estima tu BMR (Tasa Metabólica Basal), la cantidad de calorías que tu cuerpo quema en reposo, usando la Ecuación de Mifflin-St. Jeor. Luego multiplica eso por tu multiplicador de actividad para tener en cuenta el ejercicio y el estilo de vida. Necesitarás ingresar:",
      section1Sub2List: [
        "Edad, género, altura y peso",
        "Nivel de actividad, de sedentario a muy activo",
        "Objetivo: mantener, perder o ganar peso"
      ],
      section1Sub2Text: "En segundos, la calculadora de gasto energético diario total muestra cuántas calorías necesita tu cuerpo diariamente para mantener tu peso actual o avanzar hacia tu objetivo.",

      section1Sub3Title: "Por Qué Usar una Calculadora TDEE",
      section1Sub3Intro: "Esta calculadora de gasto energético te ayuda a tomar decisiones dietéticas precisas. En lugar de seguir números de calorías genéricos, sabrás exactamente cuántas calorías quema tu cuerpo cada día.",
      section1Sub3Text: "Es ideal para atletas, personas que van al gimnasio o cualquiera que busque mejorar su composición corporal. La Calculadora TDEE ofrece un enfoque basado en la ciencia para equilibrar la ingesta de alimentos, optimizar entrenamientos y mantener un peso saludable.",

      section2Title: "Fórmula de la Calculadora TDEE",
      section2Intro: "La Calculadora TDEE estima tu gasto energético diario total (TDEE) combinando dos componentes: tu Tasa Metabólica Basal (BMR) y tu multiplicador de actividad. La ecuación base utilizada es la Fórmula de Mifflin-St. Jeor, que calcula tu tasa metabólica, o la cantidad de calorías que tu cuerpo quema en reposo",
      section2Step1: "Paso 1: Calcular la Tasa Metabólica Basal (BMR)",
      section2Step1MaleFormula: "Para Hombres: BMR = 10 × peso (kg) + 6.25 × altura (cm) – 5 × edad (años) + 5",
      section2Step1FemaleFormula: "Para Mujeres: BMR = 10 × peso (kg) + 6.25 × altura (cm) – 5 × edad (años) – 161 Este número muestra el resultado del cálculo metabólico — cuántas calorías necesita tu cuerpo en reposo.",
      section2Step2: "Paso 2: Aplicar el Multiplicador de Nivel de Actividad",
      section2Step2Text: "Luego, la calculadora multiplica tu BMR por un factor de actividad para considerar el uso energético de tu nivel de actividad durante el día.",
      ...
      resulttext: "El resultado te da tu Gasto Energético Diario Total (TDEE), o calorías de mantenimiento totales.",
      section2Step3: "Paso 3: Resumen de la Fórmula",
      section2Step3Formula: "TDEE = BMR × Multiplicador de Nivel de Actividad",
      section2Step3Text: "Esta ecuación estima tu quema calórica total, cuántas calorías quemas diariamente mediante todas las actividades físicas y no físicas.",
...
>>>>>>> bd168e476cb4ec64ba35a5bc0dcf86e4955caa17
    bfp: {
      ...
      aboutText: "El porcentaje de grasa corporal es una mejor medida de la condición física que solo el peso.",
      formula: "Fórmula",
      formulaText: "Se usa la estimación a partir de medidas de circunferencia",
      faqTitle: "Preguntas Frecuentes sobre el Porcentaje de Grasa Corporal",
      faq: [
        {
          q: "¿Cuál es el porcentaje ideal de grasa corporal?",
          a: "Hombres: 10–20%, Mujeres: 18–28%. Los atletas suelen estar por debajo de estos rangos.",
        },
        {
          q: "¿La grasa corporal es lo mismo que el IMC?",
          a: "No. El IMC mide el peso respecto a la altura, no la grasa real del cuerpo.",
        },
        {
          q: "¿Puedo medir la grasa corporal en casa?",
          a: "Sí, usando cinta métrica o básculas de grasa corporal — aunque la precisión varía.",
        },
        {
          q: "¿Con qué frecuencia debo medir mi grasa corporal?",
          a: "Cada 4–6 semanas es suficiente para seguimiento sin obsesionarse.",
        },
        {
          q: "¿La grasa corporal afecta el metabolismo?",
          a: "Sí. Más músculo y menos grasa suelen significar un metabolismo más alto.",
        },
        {
          q: "¿Cuál es la manera más rápida de reducir la grasa corporal?",
          a: "Combina entrenamiento de resistencia, ligero déficit calórico y suficiente proteína.",
        },
      ],
    },
  },
  ...
  finance: {
    ...
    mortgage: {
      ...
      resultExplain: "El costo total mensual de la hipoteca incluye el capital y los intereses basados en el monto del préstamo y la tasa de interés, más gastos adicionales continuos como el impuesto a la propiedad, el seguro anual de la vivienda y las cuotas HOA. Estos costos adicionales ofrecen una visión más realista de lo que realmente pagas cada mes.",
    ...
    roi: {
      ...
      resultExplain: "El ROI (Retorno sobre la Inversión) te muestra cuánto beneficio obtuviste en comparación con lo que invertiste. Fórmula usada: ROI = (Ganancia Neta ÷ Inversión) × 100. Ganancia Neta = Retorno − Inversión − Costos. Ejemplo: Si invertiste $10,000, recibiste $14,000 y gastaste $1,000 → Ganancia Neta = 14,000 − 10,000 − 1,000 = 3,000 → ROI = (3,000 ÷ 10,000) × 100 = 30%.",
      result: "ROI %",
    ...
    breakeven: {
      ...
      resultExplain: "Este es el número de unidades que necesitas vender para cubrir todos tus costos fijos y variables antes de obtener ganancias.",
    ...
    currency: {
      ...
      inr: "Rupia India (INR)",
      resultExplain: "Este resultado muestra la cantidad convertida según la tasa que proporcionaste. El cálculo simplemente multiplica la cantidad ingresada por la tasa de conversión entre las monedas seleccionadas. Si tienes $100 USD y la tasa de conversión a PKR es 280 → tu cantidad convertida será 100 × 280 = 28,000 PKR.",
